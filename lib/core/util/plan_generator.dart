...
class PlanGenerator {
  ...
  PlanGenerator() {
    ...
    //two groups
    elements[0].connectedTable = 'T1';
    elements[1].connectedTable = 'T1';
    elements[2].canReserveTable = true;
    elements[2].groupedSittings = <String, List<String>>{
      'group1': ['S1', 'S2'],
      'group2': ['S3', 'S4'],
    };
    elements[3].connectedTable = 'T1';
    elements[4].connectedTable = 'T1';

    //one group
    elements[5].connectedTable = 'T2';
    elements[6].connectedTable = 'T2';
    elements[7].canReserveTable = true;
    elements[7].groupedSittings = <String, List<String>>{
      'group1': ['S5', 'S6', 'S7', 'S8'],
    };
    elements[8].connectedTable = 'T2';
    elements[9].connectedTable = 'T2';

    //two groups - cant reserve table
    elements[10].connectedTable = 'T3';
    elements[11].connectedTable = 'T3';
    elements[12].canReserveTable = false;
    elements[12].groupedSittings = <String, List<String>>{
      'group1': ['S9', 'S10'],
      'group2': ['S11', 'S12'],
    };
    elements[13].connectedTable = 'T3';
    elements[14].connectedTable = 'T3';

    //one group - cant reserve table
    elements[15].connectedTable = 'T4';
    elements[16].connectedTable = 'T4';
    elements[17].canReserveTable = false;
    elements[17].groupedSittings = <String, List<String>>{
      'group1': ['S13', 'S14', 'S15', 'S16']
    };
    elements[18].connectedTable = 'T4';
    elements[19].connectedTable = 'T4';

    //only table 1
    elements[20].connectedTable = 'T5';
    elements[21].connectedTable = 'T5';
    elements[22].canReserveTable = false;
    elements[22].groupedSittings = <String, List<String>>{};
    elements[23].connectedTable = 'T5';
    elements[24].connectedTable = 'T5';

    //only table 2
    elements[25].connectedTable = 'T6';
    elements[26].connectedTable = 'T6';
    elements[27].canReserveTable = false;
    elements[27].groupedSittings = <String, List<String>>{};
    elements[28].connectedTable = 'T6';
