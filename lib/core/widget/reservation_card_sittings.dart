...
class ReservationCardSittings extends StatelessWidget {
  ...
  const ReservationCardSittings({Key? key, required this.placeReservation}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return CommonCard(
        ...
        child: Column(
          children: [
            Text(chosenSittings, style: Theme.of(context).textTheme.headlineMedium),
            SizedBox(height: padding),
            Align(
                alignment: Alignment.centerLeft,
                child: Text(placeReservation.sittingsSummary, style: Theme.of(context).textTheme.bodyMedium)),
          ],
        )
    );
  }
