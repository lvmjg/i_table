...
class ReservationChatModel {
  ...
  ReservationChatModel(
      {required this.chatEnabled, required this.maxNumberOfMessages});

  factory ReservationChatModel.fromJson(Map<String, dynamic> json) =>
      _$ReservationChatModelFromJson(json);
