...
class TimeUnlimitedReservationModel{
  ...
  TimeUnlimitedReservationModel({required this.canReserveBeforeAnotherReservation, required this.reserveBeforeAnotherReservationInterval});

  factory TimeUnlimitedReservationModel.fromJson(Map<String, dynamic> json) => _$TimeUnlimitedReservationModelFromJson(json);
