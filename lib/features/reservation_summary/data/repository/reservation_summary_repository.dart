...
abstract class ReservationSummaryRepository {
  Future<Either<Failure, void>> submitReservation(
...
class ReservationSummaryRepositoryImpl implements ReservationSummaryRepository {
  ...
  @override
  Future<Either<Failure, void>> submitReservation(
      PlaceReservation placeReservation) async {
    try {
      PlaceReservationModel placeReservationModel = placeReservationsFactory
          .getModelFromPlaceReservation(placeReservation);
