...
class RestaurantReservationsRepositoryImpl
    implements RestaurantReservationsRepository {
  final RestaurantReservationsRemoteDataSource
      restaurantReservationsRemoteDataSource;

  RestaurantReservationsRepositoryImpl(
      this.restaurantReservationsRemoteDataSource);
