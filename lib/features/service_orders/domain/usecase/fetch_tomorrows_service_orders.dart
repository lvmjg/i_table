...
class FetchTomorrowsServiceOrders
  ...
  FetchTomorrowsServiceOrders(this.serviceOrdersRepository, {required this.filterCompleted});

  @override
  Either<Failure, Stream<List<PlaceOrder>>> call(PlaceIdParams params) {
    return serviceOrdersRepository.fetchTomorrowsServiceOrders(params.placeId, filterCompleted: filterCompleted);
  }
}
