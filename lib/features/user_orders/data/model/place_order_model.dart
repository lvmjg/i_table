...
class ModelConverter
    implements
        JsonConverter<Map<String, PlaceOrderItemModel>, Map<String, dynamic>> {
  const ModelConverter();

  @override
  Map<String, PlaceOrderItemModel> fromJson(Map<String, dynamic> json) {
    Map<String, PlaceOrderItemModel> map =
        json.map<String, PlaceOrderItemModel>(
            (key, value) => MapEntry(key, PlaceOrderItemModel.fromJson(value)));
    return map;
  }
