...
class FetchUserOrders implements UseCaseSync<Stream<List<PlaceOrder>>, ReservationOrdersParams> {
  final UserOrdersRepository userOrdersRepository;

  FetchUserOrders(this.userOrdersRepository);

  @override
  Either<Failure, Stream<List<PlaceOrder>>> call(ReservationOrdersParams params) {
